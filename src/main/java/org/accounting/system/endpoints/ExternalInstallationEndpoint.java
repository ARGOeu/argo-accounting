...
public class ExternalInstallationEndpoint {
    ...
    @Tag(name = "Installation")
    @Operation(
            summary = "Get report of external installation with metrics and access controls.",
            description = "Returns a report for a specific external installation and time period, including aggregated metric values and role-based access control information.")
    @APIResponse(
            responseCode = "200",

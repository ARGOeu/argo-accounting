...
@Schema(name="InstallationReportNew", description="A report for a specific installation that includes aggregated metric values over a time period.")
public class InstallationReportNew {

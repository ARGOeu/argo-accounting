...
@Schema(name="PermissionAccessControlUpdate", description="An object represents a request for updating an Access Control Entry.")
public class PermissionAccessControlUpdateDto {

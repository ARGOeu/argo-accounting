...
public class InstallationRequestDto {
    ...
    @Schema(
            type = SchemaType.STRING,
            implementation = String.class,
            description = "Unique external Installation identifier. If not provided by the client during creation, it is automatically generated by the system. " +
                    "It is used to identify and access documents through the external API endpoints.",

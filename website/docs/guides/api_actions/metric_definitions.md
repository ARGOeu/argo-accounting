...
> 📝 **For more details on how to format the request, see** [here](../../api/metric_definition/#get----fetch-all-metric-definitions).
...
> 📝 **For more details on how to format the request, see** [here](../../api/metric_definition#get---fetch-a-metric-definition).
...
> 📝 **For more details on how to format the request, see** [here](../../api/metric_definition#post---create-a-metric-definition).
...
> 📝 **For more details on how to format the request, see** [here](../../api/metric_definition#patch---update-a-metric-definition).
...
> 📝 **For more details on how to format the request, see** [here](../../api/metric_definition/#delete----delete-a-metric-definition).
...
for each field of the **[Metric Definition Collection](../../api/metric_definition)**
...
criteria in a specific **[syntax](./search-filter)**.

> 📝 **For more details on how to format the request, see** [here](../../api/metric_definition#post---search-for-metric-definitions).
